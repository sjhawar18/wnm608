...
$images = array_reduce(explode(",", $o->images),function($r,$o){return $r."<img src ='/wnm608/jhawar.shubhangi/img/$o'>";});
...
<div>
   ...
   <div class="form-control">
      ...
      <span class="images-thumbs"><img src='/wnm608/jhawar.shubhangi/img/$o->thumbnail'></span>
   </div >
   <div class="form-control">
